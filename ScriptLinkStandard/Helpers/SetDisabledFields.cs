...
namespace ScriptLinkStandard.Helpers
{
    public partial class ScriptLinkHelpers
    {
        ...
        public static OptionObject2 SetDisabledFields(IOptionObject2 optionObject, List<string> fieldNumbers)
        {
            if (optionObject == null)
                throw new System.ArgumentException("Parameter cannot be null.", "optionObject");
        ...
        public static OptionObject2015 SetDisabledFields(IOptionObject2015 optionObject, List<FieldObject> fieldObjects)
        {
            if (optionObject == null)
                throw new System.ArgumentException("Parameter cannot be null.", "optionObject");
            return SetFieldObjects(optionObject, "DISABLED", fieldObjects);
        }
        public static OptionObject2015 SetDisabledFields(IOptionObject2015 optionObject2, List<string> fieldNumbers)
        {
