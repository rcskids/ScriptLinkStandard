...
namespace ScriptLinkStandard.Objects
{
    ...
    public class OptionObject2 : IEquatable<OptionObject2>, IOptionObject2
    {
        ...
        public OptionObject2 Clone()
        {
            ...
            return (OptionObject2)this.MemberwiseClone();
        }
        /// <summary>
        ...
        {
            return (OptionObject2)ScriptLinkHelpers.GetReturnOptionObject(this);
        }
        /// <summary>
        ...
        {
            return (OptionObject2)ScriptLinkHelpers.GetReturnOptionObject(this, errorCode, errorMessage);
        }
    }
}