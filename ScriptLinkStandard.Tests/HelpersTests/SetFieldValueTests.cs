...
namespace ScriptLinkStandard.Tests.HelpersTests
{
    ...
    public class SetFieldValueTests
    {
        ...
        public void SetFieldValue_OptionObject2015_OtherRow_MI_AreEqual()
        {
            ...
            optionObject = (OptionObject2015)ScriptLinkHelpers.SetFieldValue(optionObject, "2", "2||3", "123", "Test");
            string actual = ScriptLinkHelpers.GetFieldValue(optionObject, "2", "2||3", "123");
        ...
        public void SetFieldValue_OptionObject2015_CurrentRow_MI_AreEqual()
        {
            ...
            optionObject = (OptionObject2015)ScriptLinkHelpers.SetFieldValue(optionObject, "2", "2||1", "123", "Test");
            string actual = ScriptLinkHelpers.GetFieldValue(optionObject, "2", "2||1", "123");
        ...
        public void SetFieldValue_OptionObject2015_CurrentRow_NotMI_AreEqual()
        {
            ...
            optionObject = (OptionObject2015)ScriptLinkHelpers.SetFieldValue(optionObject, "1", "1||1", "122", "Test");
            string actual = ScriptLinkHelpers.GetFieldValue(optionObject, "1", "1||1", "122");
