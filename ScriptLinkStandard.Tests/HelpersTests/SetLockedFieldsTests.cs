...
namespace ScriptLinkStandard.Tests.HelpersTests
{
    ...
    {
        [TestMethod]
        public void SetLockedFields_OptionObject_ListFieldObjects()
        {
            ...
            optionObject.SetLockedFields(fieldObjects);
            Assert.IsTrue(optionObject.IsFieldLocked(fieldNumber));
        }

        [TestMethod]
        [ExpectedException(typeof(NullReferenceException))]
        public void SetLockedFields_OptionObject_Null_ListFieldObjects()
        {
            string fieldNumber = "123";
            FieldObject fieldObject = new FieldObject(fieldNumber);
            List<FieldObject> fieldObjects = new List<FieldObject>()
        ...
        public void SetLockedFields_OptionObject_ListFieldObjects_Null()
        {
            string fieldNumber = "123";
            FieldObject fieldObject = new FieldObject(fieldNumber);
        ...
        [TestMethod]
        public void SetLockedFields_OptionObject2_ListFieldObjects()
        {
            string fieldNumber = "123";
            FieldObject fieldObject = new FieldObject(fieldNumber);
            List<FieldObject> fieldObjects = new List<FieldObject>()
        ...
        [TestMethod]
        [ExpectedException(typeof(NullReferenceException))]
        public void SetLockedFields_OptionObject2_Null_ListFieldObjects()
        {
            string fieldNumber = "123";
            FieldObject fieldObject = new FieldObject(fieldNumber);
            List<FieldObject> fieldObjects = new List<FieldObject>()
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void SetLockedFields_OptionObject2_ListFieldObjects_Null()
        {
            string fieldNumber = "123";
            FieldObject fieldObject = new FieldObject(fieldNumber);
            List<FieldObject> fieldObjects = null;
        ...
        [TestMethod]
        public void SetLockedFields_OptionObject2015_ListFieldObjects()
        {
            string fieldNumber = "123";
            FieldObject fieldObject = new FieldObject(fieldNumber);
            List<FieldObject> fieldObjects = new List<FieldObject>()
        ...
        [TestMethod]
        [ExpectedException(typeof(NullReferenceException))]
        public void SetLockedFields_OptionObject2015_Null_ListFieldObjects()
        {
            string fieldNumber = "123";
            FieldObject fieldObject = new FieldObject(fieldNumber);
            List<FieldObject> fieldObjects = new List<FieldObject>()
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void SetLockedFields_OptionObject2015_ListFieldObjects_Null()
        {
            string fieldNumber = "123";
            FieldObject fieldObject = new FieldObject(fieldNumber);
            List<FieldObject> fieldObjects = null;
