...
Implements [IEquatable&lt;T&gt;](https://docs.microsoft.com/en-us/dotnet/api/system.iequatable-1?view=netstandard-1.1), [IOptionObject](/ScriptLinkStandard/api/scriptlinkstandard.interfaces/ioptionobject.md)
