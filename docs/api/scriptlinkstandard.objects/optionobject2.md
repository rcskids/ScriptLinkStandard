...
Implements [IEquatable&lt;T&gt;](https://docs.microsoft.com/en-us/dotnet/api/system.iequatable-1?view=netstandard-1.1), [IOptionObject2](/ScriptLinkStandard/api/scriptlinkstandard.interfaces/ioptionobject2.md)
