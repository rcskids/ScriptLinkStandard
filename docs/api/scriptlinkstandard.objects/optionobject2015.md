...
Implements:
* [IEquatable<T>](https://docs.microsoft.com/en-us/dotnet/api/system.iequatable-1?view=netstandard-1.1)
* [IOptionObject2015](/docs/api/scriptlinkstandard.interfaces/ioptionobject2015.md)
